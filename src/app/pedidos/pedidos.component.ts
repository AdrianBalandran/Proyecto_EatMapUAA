...
export class PedidosComponent {
  ...
  pedidoEntregado(idOrden: any){
    ...
    const urlAPI: string = "http://192.168.100.25:3000/pedido/entregado"; 
  ...
  pedidoCancelado(idOrden: any){
    ...
    const urlAPI: string = "http://192.168.100.25:3000/pedido/cancelado"; 
    this.getusu.postNodeEntregado(urlAPI, orden);
    this.actualizar(); 
  }
  ...
  actualizar(){
    if(this.session.isAuthenticated()){
      ...
      const urlAPII: string = "http://192.168.100.25:3000/pedidos"; 
      const urlAPIII: string = "http://192.168.100.25:3000/usuario/get"; 
      ...
      this.getusu.getusuario(urlAPIII, user).subscribe((res: any) => {
        ...
        if(usuario.Tipo == "Encargado"){
          ...
          const urlAPII: string = "http://192.168.100.25:3000/pedidos/getEnc"; 
